...
/* Fetch XML from yr api and parses it into JSON and writes to file*/
...
const url = "https://www.yr.no/place/Norway/Tr%C3%B8ndelag/Trondheim/Trondheim/forecast.xml";
fetchXML(url ); 
